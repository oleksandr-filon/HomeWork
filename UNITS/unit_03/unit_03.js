...
function f7() {
   let inp = +document.querySelector('.i-71').value;
   let inp1 = +document.querySelector('.i-72').value;
   let out = document.querySelector('.out-7');
   out.innerHTML = Math.pow(inp, inp1);
}
...
switch (select.value) {
   case '1':
      out.innerHTML="one";break;
   case '2':
      out.innerHTML="two";break;
   case '3':
      out.innerHTML="three";break;  
}
}
...
function f12() {
   let inp =document.querySelector('.i-120');
   let out = document.querySelector('.out-12');
   document.querySelector('.out-12').innerHTML = (typeof inp.value);
...
function f15() {
   let sel = +document.querySelector('.s-151').value;
